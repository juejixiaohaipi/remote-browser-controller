...
(function() {
  ...
  function connectToBackground() {
    if (reconnectCount >= MAX_RECONNECT) {
      console.error('[RBC-Relay] Max reconnection attempts reached, giving up');
      return;
    }
    try {
      ...
      rbcPort.onDisconnect.addListener(() => {
        ...
        console.log(`[RBC-Relay] Port disconnected, reconnecting in ${delay}ms (attempt ${reconnectCount}/${MAX_RECONNECT})`);
      ...
      reconnectCount++;
      console.error(`[RBC-Relay] Failed to connect port (attempt ${reconnectCount}/${MAX_RECONNECT}):`, err);
      if (reconnectCount < MAX_RECONNECT) {
